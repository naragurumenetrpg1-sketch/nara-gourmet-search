    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light mb-4 sm:mb-6 tracking-wide">
            奈良グルメ検索
            <span className="block text-lg sm:text-xl md:text-2xl font-thin text-gray-300 mt-2">SEARCH ENGINE</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-300 font-light">2つの条件で、理想のお店を見つけよう</p>
