    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-10 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light mb-3 sm:mb-4 tracking-normal">
            奈良グルメ検索
            <span className="block text-lg sm:text-xl md:text-2xl font-thin text-gray-300 mt-1 sm:mt-2">SEARCH ENGINE</span>
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-gray-300 font-light">2つの条件で、理想のお店を見つけよう</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6 md:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              <div className="relative">
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">地名・駅名</label>
                <div className="relative">
                  <MapPin className="absolute left-3 sm:left-4 top-3 sm:top-4 h-4 w-4 sm:h-5 sm:w-5 text-gray-400" />
                  <input
                    className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black outline-none transition-all duration-300 text-gray-900 placeholder-gray-500"
              ...
              {/* ジャンル入力 */}
              <div className="relative">
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">ジャンル</label>
                <div className="relative">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center">
              <button
                className={`flex-1 sm:flex-none px-8 sm:px-12 py-3 sm:py-4 text-sm sm:text-base rounded-lg font-medium transition-all duration-300 ${
              ...
              >
                <Search className={`h-4 w-4 sm:h-5 sm:w-5 ${isSearching ? "animate-spin" : ""}`} />
                {isSearching ? "検索中..." : "検索する"}
              </button>
              <button
                className="flex-1 sm:flex-none px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-lg font-medium border border-gray-300 hover:bg-gray-50 text-gray-700 transition-all duration-300"
                onClick={clearSearch}
              >
                クリア
              </button>
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    {store.link && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-black hover:text-gray-600 font-medium transition-colors duration-300 text-xs sm:text-sm"
                      >
