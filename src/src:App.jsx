        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 sm:p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button
                className={`px-8 sm:px-12 py-3 sm:py-4 text-sm sm:text-base rounded-lg font-medium transition-all duration-300 ${
              ...
              <button
                className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-lg font-medium border border-gray-300 hover:bg-gray-50 text-gray-700 transition-all duration-300"
                onClick={clearSearch}
              >
                クリア
              </button>
