      ...
      <div className="bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-12 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-light mb-4 tracking-tight">
            奈良グルメ検索
            <span className="block text-xl sm:text-2xl md:text-3xl font-thin text-gray-300 mt-3">SEARCH ENGINE</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-300 font-light mt-6">2つの条件で、理想のお店を見つけよう</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
            ...
            <div className="flex gap-4 justify-center">
              <button
                className={`flex-1 max-w-xs px-12 py-4 text-base rounded-lg font-medium transition-all duration-300 ${
              ...
              <button
                className="flex-1 max-w-xs px-8 py-4 text-base rounded-lg font-medium border border-gray-300 hover:bg-gray-50 text-gray-700 transition-all duration-300"
                onClick={clearSearch}
              >
                クリア
              </button>
