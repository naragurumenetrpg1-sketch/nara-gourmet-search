              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-gray-600 transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M19 6.5c0-.83-.67-1.5-1.5-1.5h-11C5.67 5 5 5.67 5 6.5v11c0 .83.67 1.5 1.5 1.5h11c.83 0 1.5-.67 1.5-1.5v-11zM12 3c-.55 0-1 .45-1 1v1h2V4c0-.55-.45-1-1-1zm6 2v1h-2V5h1c.55 0 1 .45 1 1zM6 6c0-.55.45-1 1-1h1v1H6zm0 12v-1h2v1H7c-.55 0-1-.45-1-1zm12 1h-1v-1h2v1c0 .55-.45 1-1 1zm-6-3c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
                      <path d="M11 11.5c0-.28.22-.5.5-.5h1c.28 0 .5.22.5.5v2c0 .28-.22.5-.5.5h-1c-.28 0-.5-.22-.5-.5v-2z"/>
                      <path d="M14.5 8c-.28 0-.5.22-.5.5v.5h-4v-.5c0-.28-.22-.5-.5-.5s-.5.22-.5.5V10c0 .28.22.5.5.5h.5v1h-.5c-.28 0-.5.22-.5.5s.22.5.5.5h.5v1h-.5c-.28 0-.5.22-.5.5s.22.5.5.5h5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5h-.5v-1h.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5h-.5v-1h.5c.28 0 .5-.22.5-.5V8.5c0-.28-.22-.5-.5-.5z"/>
                    </svg>
                  </div>
                </div>
              </a>
